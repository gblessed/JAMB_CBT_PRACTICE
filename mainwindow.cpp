...
//createDetails->setFixedWidth(static_cast<int>(this->width()/0.8));
//createDetails->setFixedHeight(static_cast<int>(this->height()/0.8));
...
//loginDetails->setFixedWidth(static_cast<int>(this->width()/1.5));
//loginDetails->setFixedHeight(static_cast<int>(this->height()/1.5));
